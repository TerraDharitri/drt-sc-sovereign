...
use dharitri_sc_scenario::{
    api::StaticApi, dharitri_chain_vm::crypto_functions::sha256, ScenarioTxRun,
};
use dharitri_sc_scenario::{ReturnsHandledOrError, ReturnsLogs};
...
impl HeaderVerifierTestState {
    ...
    pub fn propose_register_dcdt_address(&mut self, dcdt_address: TestAddress) {
        self.common_setup
            .world
            .tx()
            .from(OWNER_ADDRESS)
