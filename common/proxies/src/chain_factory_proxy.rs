    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn set_dcdt_safe_address_in_header_verifier<
        Arg0: ProxyArg<ManagedAddress<Env::Api>>,
        Arg1: ProxyArg<ManagedAddress<Env::Api>>,
    >(
        self,
        header_verifier: Arg0,
        dcdt_safe_address: Arg1,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("setDcdtSafeAddressInHeaderVerifier")
            .argument(&header_verifier)
            .argument(&dcdt_safe_address)
            .original_result()
    }

    pub fn deploy_enshrine_dcdt_safe<
        Arg0: ProxyArg<bool>,
        Arg1: ProxyArg<ManagedAddress<Env::Api>>,
        Arg2: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg3: ProxyArg<ManagedBuffer<Env::Api>>,
        Arg4: ProxyArg<Option<DcdtSafeConfig<Env::Api>>>,
    >(
        self,
        is_sovereign_chain: Arg0,
        token_handler_address: Arg1,
        wrewa_identifier: Arg2,
        sov_token_prefix: Arg3,
        opt_config: Arg4,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedAddress<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("deployEnshrineDcdtSafe")
            .argument(&is_sovereign_chain)
            .argument(&token_handler_address)
            .argument(&wrewa_identifier)
            .argument(&sov_token_prefix)
            .argument(&opt_config)
            .original_result()
    }

    pub fn deploy_dcdt_safe<
        Arg0: ProxyArg<bool>,
        Arg1: ProxyArg<ManagedAddress<Env::Api>>,
    >(
        self,
