...
pub const ONLY_DCDT_SAFE_CALLER: &str = "Only DCDT Safe can call this endpoint";
pub const INVALID_FEE: &str = "Invalid fee";
pub const INVALID_DCDT_IDENTIFIER: &str = "Invalid DCDT identifier";
pub const INVALID_WREWA_USDC_PAIR_ADDRESS: &str = "Invalid WREWA-USDC pair address from router";
...
pub const NO_DCDT_SAFE_ADDRESS: &str = "There is no registered DCDT address";
pub const HASH_OF_HASHES_DOES_NOT_MATCH: &str =
    "Hash of all operations doesn't match the hash of transfer data";
pub const DCDT_SAFE_STILL_PAUSED: &str = "Cannot create transaction while paused";
